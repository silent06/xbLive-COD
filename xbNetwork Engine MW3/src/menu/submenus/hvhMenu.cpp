...
namespace HvHMenuVars {
	...
	ScrollStruct<int> XDirections[] = {
		"Shield", 0, // Static vertical (look up with -10 deg)
		"Verticle Jitter", 1, // Changed from spin, set speed to 45
		"Look Up", 2, // Looking up all the time
		"Look Down", 3, // Looking down all the time
	};

	ScrollStruct<int> YDirections[] = {
		"Shield", 0, // Face opposite direction
		"Random Jitter", 1, // Changed from shield
		"Spin", 2, // Spins around
		"Fake", 3, // Static angle
	};
