...
public:
	...
	struct Materials {
		...
		Material* compass_objpoint_airstrike_busy;
		Material* compass_objpoint_helicopter_busy;
		Material* compass_objpoint_airstrike_friendly;
		Material* compass_objpoint_helicopter_friendly;
	} Materials;
